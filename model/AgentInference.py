...
if __name__ == "__main__":
    prompt = """
        ...
        Return only the minimum years of required experience. If no experience is mentioned respond 0 years.
        Below are several examples of what you should do.
        
        [Example]
        [Description] As a software engineer with 3-5 years of development experience[EndDescription]
        
        What is the minimum required years of experience?
        [Response] 3 years [EndResponse]
        [EndExample]
        
        [Example]
        [Description] As a banker with 2 years of banking experience and 5 years of telecommunications experience[EndDescription]
        ...
        What is the minimum required years of experience?
        [Response] 0 years [EndResponse]
        [EndExample]
        
        Using the above examples and the following job description, determine the minimum years of experience.
        [Description]
        'Are you looking for more? Find it here. At Wells Fargo, we believe that a meaningful career is much more than just a job. It''s about finding all the elements that help you thrive, in one place. means you''re supported in life, not just work. It means having a competitive salary, a robust benefits package, and programs to support your work-life balance and well-being. It means being rewarded for investing in your community, celebrated for being your authentic self, and empowered to grow. And we''re recognized for it! Wells Fargo ranked in the top three on the 2024 LinkedIn Top Companies List of best workplaces "to grow your career" in the U.S.
...
See who you know'
        ...
        What is the minimum requrired years of experience?
        """
